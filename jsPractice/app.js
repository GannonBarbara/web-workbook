...
document.write(multiplyTwoNumbers(itemThree, item))
document.write("<hr/>") // Don't worry about this line. 
...
document.write(divideTwoNumbers(itemThree, item))
document.write("<hr/>") // Don't worry about this line. 
...
document.write(isGreaterThan(itemFour, itemFive))
document.write("<hr/>") // Don't worry about this line. 
...
var helloSnoopOne = 'Hello'
var helloSnoopTwo = 'Snoopy'

function greetUser (greeting, first, last) {
  return greeting + " " + first + " " + last
}


document.write(greetUser(greeting, firstName, lastName))
document.write("<hr/>") // Don't worry about this line. 


document.write(greetUser('Yo', 'Gann', 'Berr'))
document.write("<hr/>") // Don't worry about this line. 
